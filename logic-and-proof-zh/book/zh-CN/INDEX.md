...
- [一阶逻辑的语义](semantics_of_first_order_logic.md) — 解释、模型中的真、例子、有效性与逻辑后承、可靠性与完全性、练习

### 第 11 章：集合

- [集合](sets.md) — 集合论基础、集合运算、指标族、笛卡尔积与幂集、练习

### 第 12 章：Lean 中的集合

- [Lean 中的集合](sets_in_lean.md) — `Set` 类型、外延性、并交补、指标族、幂集、练习

### 第 13 章：关系

- [关系](relations.md) — 偏序与全序、严格序、极小元与最小元、等价关系与商、练习

### 第 14 章：Lean 中的关系

- [Lean 中的关系](relations_in_lean.md) — `A → A → Prop`、序关系类、数上的序、等价关系、练习

### 第 15 章：函数

- [函数](functions.md) — 函数概念、单射/满射/双射、逆函数、像与原像、函数与关系、练习

## 待翻译章节

### 第 16 章：Lean 中的函数

- [Lean 中的函数](functions_in_lean.md) — 函数作为 `A → B`、单射/满射/双射的形式化、像与原像、练习
